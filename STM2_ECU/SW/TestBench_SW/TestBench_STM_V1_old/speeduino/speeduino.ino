/*
The aim of this firmware is to drive a hub chassis dyno. The main ouput of the device is an analog output in a 0-5[V] range.
This signal will represent the relative braking torque of the dyno. The maximum dyno braking torque depends on the HW itself.
Inputs : Wheel speed in RPM
          Torque at wheel
...
void setup()
{
  ...
  if(configPage1.pinMapping > BOARD_NR_GPIO_PINS)
  {
    ...
    setPinMapping(4); //Force board to ECU_STM2
