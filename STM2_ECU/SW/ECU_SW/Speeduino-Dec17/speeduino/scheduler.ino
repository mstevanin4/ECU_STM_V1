...
void setFuelSchedule1(unsigned long timeout, unsigned long duration)
{
  ...
  else
  {
    ...
    fuelSchedule1.nextStartCompare = FUEL1_COUNTER + timeout_timer_compare;
...
void setFuelSchedule2(unsigned long timeout, unsigned long duration)
{
  ...
  else
  {
    //If the schedule is already running, we can set the next schedule so it is ready to go
    //This is required in cases of high rpm and high DC where there otherwise would not be enough time to set the schedule
    fuelSchedule2.nextStartCompare = FUEL2_COUNTER + timeout_timer_compare;
...
void setFuelSchedule3(unsigned long timeout, unsigned long duration)
{
  ...
  else
  {
    //If the schedule is already running, we can set the next schedule so it is ready to go
    //This is required in cases of high rpm and high DC where there otherwise would not be enough time to set the schedule
    fuelSchedule3.nextStartCompare = FUEL3_COUNTER + timeout_timer_compare;
...
void setFuelSchedule4(unsigned long timeout, unsigned long duration) //Uses timer 4 compare B
{
  ...
  else
  {
    //If the schedule is already running, we can set the next schedule so it is ready to go
    //This is required in cases of high rpm and high DC where there otherwise would not be enough time to set the schedule
    fuelSchedule4.nextStartCompare = FUEL4_COUNTER + timeout_timer_compare;
