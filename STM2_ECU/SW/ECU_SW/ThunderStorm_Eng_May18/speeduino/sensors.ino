...
void readTPS()
{
  ...
  if (configPage2.tpsMin < configPage2.tpsMax)  //ECU_STM2
  {
  ...
  else  // for inverted TPS
  {
    ...
    currentStatus.TPS = map(tempADC, configPage2.tpsMax, configPage2.tpsMin, 100, 0); //Take the raw TPS ADC value and convert it into a TPS% based on the calibrated values
    currentStatus.TPS_time = currentLoopTime; 
   }  //ECU_STM2
}
